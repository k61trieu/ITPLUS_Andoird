...
import com.example.trieunv.MainActivity;
...
public class NextDayActivity extends AppCompatActivity {
    ...
    public static final String API_KEY = "acbae9c57a24663635f3918fd4e8f0c7";
...
//        getJsonNextDay();
    ...
    private void getJsonNextDay(String city){
        String url = "http://api.openweathermap.org/data/2.5/forecast?q="+city+"&appid=acbae9c57a24663635f3918fd4e8f0c7&units=metric";
